...
<div class="entity-container">
    ...
    <div class="header-container">
        ...
        <div class="meta-infos">
            ...
            <h2 class="title">Editar Massa: {{$pasta->name}}</h2>
    ...
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="col-12">
                <form class="form-default" action="{{route('pastas.update', $pasta->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-5">
                            <div class="form-floating">
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{old('name') ?? $pasta->name}}">
                        ...
                        <div class="col-12 mb-5">
                            <div class="form-floating">
                                ...
                                if(isset($pasta->price)){
                                $price = number_format($pasta->price, 2, ',', '.');
                                }
                                @endphp
