...
<div class="table-container">
    ...
    <div class="header-table">
        ...
        <div class="meta-infos">
            ...
            <h2 class="title">Clientes <span id="entity-quantity">({{ $total }})</span></h2>

            <div class="filter">

                <form class="search-container" action="{{route('clients.consult')}}" method="post" id="search-entity">
                ...
                <a href="{{route('clients.create')}}" class="new-button">Novo</i></a>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action details">
                            <a href="{{route('clients.address.index', $row->id)}}">
