...
<div class="table-container">
    ...
    <div class="header-table">
        ...
        <div class="meta-infos">
            ...
            <h2 class="title">Tamanhos <span id="entity-quantity">({{ $total }})</span></h2>

            <div class="filter">

                <form class="search-container" action="{{route('sizes.consult')}}" method="post" id="search-entity">
                ...
                <a href="{{route('sizes.create')}}" class="new-button">Novo</i></a>
                    ...
                    <td>
                        <div class="actions">
                            ...
                            <div class="action details">
                                <a href="{{route('sizes.show', $row->id)}}"><i class="mdi mdi-magnify"></i></a>
                            </div>

                            <div class="action edit">
                                <a href="{{route('sizes.edit', $row->id)}}"><i class="mdi mdi-pencil icon"></i></a>
                            </div>

                            <div class="action delete">
                                <a href="{{route('sizes.destroy', $row->id)}}"><i class="mdi mdi-delete icon"></i></a>
                            </div>
