...
<div class="table-container">
    ...
    <div class="header-table">
        ...
        <div class="meta-infos">
            ...
            <h2 class="title">Ingredientes <span id="entity-quantity">({{ $total }})</span></h2>

            <div class="filter">

                <form class="search-container" action="{{route('ingredients.consult')}}" method="post" id="search-entity">
                ...
                <a href="{{route('ingredients.create')}}" class="new-button">Novo</i></a>
