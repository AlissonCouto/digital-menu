...
<div class="entity-container">
    ...
    <div class="header-container">
        ...
        <div class="meta-infos">
            ...
            <h2 class="title">Editar Funcionário: {{$employee->name}}</h2>
    ...
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="col-12">
                <form class="form-default" action="{{route('employees.update', $employee->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-5">
                            <div class="form-floating">
                                <input type="text" name="cpf" id="cpf" class="form-control cpfMask @error('cpf') is-invalid @enderror" value="{{old('cpf') ?? $employee->cpf}}">
                        ...
                        <div class="col-12 col-md-6 mb-5">
                            <div class="form-floating">
                                <input type="date" name="birth" id="birth" class="form-control @error('birth') is-invalid @enderror" value="{{old('birth') ?? $employee->birth}}">
                        ...
                        <div class="col-12 col-md-6 mb-5">
                            <div class="form-floating">
                                <input type="text" name="phone" id="phone" class="form-control phoneMask @error('phone') is-invalid @enderror" value="{{old('phone') ?? $employee->phone}}">
                        ...
                        <div class="col-12 mb-5">
                            ...
                            <div class="form-floating">
                                <select id="type" class="form-control @error('type') is-invalid @enderror" name="type">
                                    <option value="attendant" {{$employee->type == 'attendant' ? 'selected' : ''}}>Atendente</option>
                                    <option value="admin" {{$employee->type == 'admin' ? 'selected' : ''}}>Administrador</option>
                                </select>
