...
<div class="entity-container">
    ...
    <div class="header-container">
        ...
        <div class="meta-infos">
            ...
            <h2 class="title">Editar Borda: {{$border->name}}</h2>
    ...
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="col-12">
                <form class="form-default" action="{{route('borders.update', $border->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-5">
                            <div class="form-floating">
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{old('name') ?? $border->name}}">
                        ...
                        <div class="col-12 mb-5">
                            <div class="form-floating">
                                ...
                                if(isset($border->price)){
                                $price = number_format($border->price, 2, ',', '.');
                                }
                                @endphp
