jQuery(function($){
    ...
    let $initialCart = $('#initial-cart').val();
    
    saveOrder(JSON.parse($initialCart));
    updateOrder();
    /* Salvando pedidos */
    ...
    function updateLabelAddress($address){
        ...
        if(typeof $address.street != 'undefined'){
            ...
            $('.create-orders .resume-address .address').html(`<i class="mdi mdi-map-marker"></i> ${$address.street}, ${$address.number}. ${$address.neighborhood}${$reference}`);
        }else{
